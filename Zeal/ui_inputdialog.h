...
{
public:
	bool show(const std::string& title, const std::string& message, const std::string& button1, const std::string button2, InputDialogCallback button1_callback, InputDialogCallback button2_callback);
	void hide();
	bool isVisible();
