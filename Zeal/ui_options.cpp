...
void ui_options::InitGeneral()
{
	...
	ui->AddCheckboxCallback(wnd, "Zeal_RightClickToEquip",      [](Zeal::EqUI::BasicWnd* wnd) { ZealService::get_instance()->equip_item_hook->SetEnabled(wnd->Checked); });
...
void ui_options::UpdateOptionsGeneral()
{
	...
	ui->SetChecked("Zeal_RightClickToEquip", ZealService::get_instance()->equip_item_hook->enabled);
}
